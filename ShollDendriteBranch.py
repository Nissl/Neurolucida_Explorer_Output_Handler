##This script produces a Sholl analysis of the number of branches at a distance from the cell body.
##This is the "classic" Sholl dendrite analysis you most often see reported (e.g., in 80's papers).
##This script takes the Neurolucida Explorer spreadsheet "sholl dendrite" as input.
...
outputfile = "sholldendritebranch.xls"
    ...
    try:
        ...
        while distance < sholl_num:
            try:
                ...
                value = 0
            sheet1.write(filecount, (distance+1), value)
            distance += 1 
    except:
