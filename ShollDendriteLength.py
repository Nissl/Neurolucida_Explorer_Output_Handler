...
##This script takes the Neurolucida Explorer spreadsheet "sholl dendrite" as an input.
##You can also use ShollDendriteLengthBranchOrder.py, which takes "branch order dendrite" as an input.
...
outputfile = "sholldendritelengthtest.xls"
...
for entry in range(0,sholl_num):
    caption = "Sholl Length " + str(entry * sholl_interval)
