...
# from the cell body. To get spine density at distances from a cell body (e.g. 
# as in several papers by Elston et al.): Divide the output of this file by 
# the output from a ShollDendriteLength.py run, which took input at the same 
# interval as this file, and with *only* trees counted for spines highlighted.
# This script takes the Neurolucida Explorer spreadsheet "sholl dendrite" as 
# an input. You need to set the sholl_interval value in this file to the 
# interval you specify in Neurolucida Explorer.
...
# input files
outputfile = "sholldendritespinetestCSV.txt"
