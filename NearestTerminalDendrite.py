# This script produces a spreadsheet listing the average distance between a 
# dendrite's termination and its nearest neighbor's termination, for each cell 
# analyzed. It takes the Neurolucida Explorer spreadsheet "nearest terminal 
# dendrite" as input.
...
# input files
outputfile = "nearestterminaldendritetestCSV.txt"
...
captions = ["Filename", "Dend Term NN"]
