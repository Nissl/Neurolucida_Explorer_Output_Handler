##This script produces a spreadsheet listing the average distance between a dendrite's 
##termination and its nearest neighbor's termination, for each cell analyzed. 
##It takes the Neurolucida Explorer spreadsheet "nearest terminal dendrite" as input.
...
for filename in filelist:
    ...
    try:
        ...
        nodenumber = 0    
        for node in inputs:
            distance_sum = distance_sum + float(node)
            nodenumber += 1 
        average = distance_sum / nodenumber
