# This script returns the average distance between a cell's soma and the 
# termination of its dendrites. This script takes the Neurolucida Explorer 
# spreadsheet "terminal distance dendrite" as an input.
...
# input files
outputfile = "terminaldistancedendritetestCSV.txt"
...
captions = ["Cell", "Avg Dend Term Dist"]
