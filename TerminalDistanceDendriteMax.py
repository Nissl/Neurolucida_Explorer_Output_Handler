##This script returns the distance between a cell's soma and the termination of the
##dendrite that is farthest from the cell.
...
outputfile = "terminaldistancedendritemaxtest.xls"
