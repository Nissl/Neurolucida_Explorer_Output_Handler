# This script produces a spreadsheet listing somal size and roundness for each
# cell analyzed. It takes the Neurolucida Explorer spreadsheet "cell bodies" 
# as input.
...
# input files
outputfile = "cellbodiestestCSV.txt"
...
captions = ["Cell", "Somal Size", "Roundness"]
...
for filename in filelist:
    ...
    try:
        ...
        input1 = input1[1:]
        input2 = input2[1:]
        output_writer.writerow([filename, input1[0], input2[0]])
    except:
